...
(function ($) {
    ...
    leaf.message = function (content, type) {
        type = type || "success";
        leaf.messageIndex++;
        var message = $('<div class="leaf-message" style="position: absolute;top:150px;width:100%;text-align: center;z-index: ' + leaf.messageIndex + '"><span class="icon"></span><span  style="min-width: 300px;display: inline-block" class="alert alert-' + type + '">' + content + '</span></div>');
        $("body").append(message);
        setTimeout(function () {
            message.remove();
        }, 1000)
