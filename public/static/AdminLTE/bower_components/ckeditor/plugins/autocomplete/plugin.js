...
(function () {
    function f(a, b) {
        ...
        if ("ready" === this.editor.status) this.attach(); else this.editor.on("instanceReady", function () {
            this.attach()
        }, this)
    }
    ...
    CKEDITOR.plugins.add("autocomplete", {
        requires: "textwatcher", onLoad: function () {
    ...
    f.prototype = {
        attach: function () {
            ...
            this._listeners.push(c.on("scroll",
                function () {
            ...
            this._listeners.push(this.view.element.on("mousedown", function (a) {
            ...
            if (this.model.isActive) {
                ...
                27 == b ? (this.close(), this.textWatcher.unmatch(), c = !0) : 40 == b ? (this.model.selectNext(), c = !0) : 38 == b ? (this.model.selectPrevious(), c = !0) : -1 != CKEDITOR.tools.indexOf(this.commitKeystrokes, b) && (this.commit(), this.textWatcher.unmatch(), c = !0);
    ...
    g.prototype = {
        append: function () {
            ...
            a.setStyle("z-index", this.editor.config.baseFloatZIndex -
                3);
            return a
        ...
        setPosition: function (a) {
            var b = this.editor, c = this.element.getSize("height"), d = b.editable(),
                b = CKEDITOR.env.iOS && !d.isInline() ? b.window.getFrame().getParent().getClientRect(!0) : d.isInline() ? d.getClientRect(!0) : b.window.getFrame().getClientRect(!0),
                d = a.top - b.top, k = b.bottom - a.bottom, e;
    ...
    h.prototype = {
        getIndexById: function (a) {
            ...
            if (null == this.selectedItemId) this.selectLast(); else {
                var a = this.getIndexById(this.selectedItemId);
            ...
            this.dataCallback({query: a, range: b},
                function (a) {
