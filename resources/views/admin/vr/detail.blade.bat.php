            ...
            <div class="vr-right">
                ...
                <div class="set-hot-choice section">
                    ...
                    <div class="hot-label">
                        <p>场景跳转标签</p>
                        <ul>
                            {{--<li><img onclick="addHotspots('u104');" src="{{asset('public/static/hotsport')}}/css/icon/u104.svg" alt=""></li>
                            <li><img onclick="addHotspots('u31');" src="{{asset('public/static/hotsport')}}/css/icon/u31.svg" alt=""></li>
                            <li><img onclick="addHotspots('u26');" src="{{asset('public/static/hotsport')}}/css/icon/u26.svg" alt=""></li>--}}

                            <li class="gopng_red-point_outer"><img onclick="addHotspots('u104');" src="{{asset('public/static/hotsport')}}/css/icon/red-point.png" alt=""></li>
